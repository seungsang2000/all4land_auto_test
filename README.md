...
이에 따라 테스트 대상 URL을 Excel 기준으로 정리하여 표준화 하였고, 이후 해당 Excel 파일을 업로드하면 각 URL을 자동으로 호출한 뒤 결과를 다시 Excel 파일로 내려받을 수 있도록 구현했습니다.
해양정보 활용시스템과 함께 운영하기 용이하도록 전자정부프레임워크 기반으로 제작하였습니다.
openAPI Key 등 민감정보는 액셀 파일에만 보관하도록 하였습니다.
